        ...
        if (!isRequest) {
            ...
            try {
                ...
                if (it == null || !it.hasNext()) {
                    generateSOAPErrMessage(soapMsg, "No header block for username.");
                }
                ...
                NodeList credentials = (userNode == null) ? null : userNode.getChildNodes();
                String username = credentials.item(0).getNodeValue();
                String password = credentials.item(1).getNodeName();
                ...
                if (UserUtil.validateUserCredentials(user, session) == null) {
                    generateSOAPErrMessage(soapMsg, "Invalid credentials address, access is denied.");
                }
